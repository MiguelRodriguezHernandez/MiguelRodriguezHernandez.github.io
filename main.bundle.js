...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__grafica_grafica_component__ = __webpack_require__("./src/app/grafica/grafica.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__grafica_grafica_component__["a" /* GraficaComponent */]
            ],
            imports: [
...
var FormularioComponent = /** @class */ (function () {
    function FormularioComponent(form) {
        ...
        this.MASCULINO = [];
        this.FEMENINO = [];
        this.pieChartLabels = ['FEMENINO', 'MASCULINO'];
    ...
    FormularioComponent.prototype.Enviar = function () {
        var _this = this;
        this.bandera = true;
        if (this.Nombres.length > 0) {
            this.Nombres.forEach(function (value) {
                if (_this.Nombres[value] === _this.xForm.get('nombres').value)
                    _this.bandera = false;
            });
        }
        if (this.bandera) {
    ...
    FormularioComponent.prototype.Actualiza = function () {
        var pieChartData = [0, 0];
        pieChartData[0] = this.FEMENINO.length;
        pieChartData[1] = this.MASCULINO.length;
        this.pieChartData = pieChartData;
    };
    FormularioComponent.prototype.ValidaNombre = function () {
        var _this = this;
        if (this.Nombres.length > 0) {
            this.Nombres.forEach(function (value) {
                if (_this.Nombres[value] === _this.xForm.get('nombres').value)
...
/***/ "./src/app/grafica/grafica.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/grafica/grafica.component.html":
/***/ (function(module, exports) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GraficaComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var GraficaComponent = /** @class */ (function () {
    function GraficaComponent() {
    }
    GraficaComponent.prototype.ngOnInit = function () {
    };
    GraficaComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-grafica',
            template: __webpack_require__("./src/app/grafica/grafica.component.html"),
            styles: [__webpack_require__("./src/app/grafica/grafica.component.css")]
        })
    ], GraficaComponent);
